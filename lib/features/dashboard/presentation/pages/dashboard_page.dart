...
import 'package:learning_project/features/dashboard/presentation/providers/dashboard_provider.dart';
import 'package:learning_project/features/dashboard/presentation/widgets/dashboard_widgets.dart';
import 'package:learning_project/features/mahasiswa/presentation/pages/mahasiswa_page.dart';
import 'package:learning_project/features/mahasiswa_aktif/presentation/pages/mahasiswa_aktif_page.dart';
import 'package:learning_project/features/dosen/presentation/pages/dosen_page.dart';
import 'package:learning_project/features/profile/presentation/pages/profile_page.dart';
    ...
    return Scaffold(
      body: dashboardState.when(
        ...
        error: (error, stack) => Center(
          child: Text('Gagal memuat data: ${error.toString()}'),
        ),
        data: (dashboardData) {
